...
public static class IServiceCollectionExtensions
{
    ...
    public static void AddSwaggerGen(this IServiceCollection services)
    {
        ...
        {
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "UrlShortener.Api.xml"));
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "UrlShortener.Shared.xml"));
